...
/**
* Modified to include functions from https://github.com/lemire/FastPFor/blob/master/src/bitpacking.cpp
*/
...
#ifndef DICT_UTIL_BPACKING_H
#define DICT_UTIL_BPACKING_H
#include <cstdint>
...
inline int packwithoutmask32(const uint32_t* in, uint32_t* out, int batch_size, int num_bits) {
    ...
    case 1:
        for (int i = 0; i < num_loops; ++i)
            __fastpackwithoutmask1(in + i * 32, out + i * num_bits);
        break;
    case 2:
        for (int i = 0; i < num_loops; ++i)
            __fastpackwithoutmask2(in + i * 32, out + i * num_bits);
        break;
    case 3:
        for (int i = 0; i < num_loops; ++i)
            __fastpackwithoutmask3(in + i * 32, out + i * num_bits);
        break;
    case 4:
        for (int i = 0; i < num_loops; ++i)
            __fastpackwithoutmask4(in + i * 32, out + i * num_bits);
        break;
    case 5:
        for (int i = 0; i < num_loops; ++i)
            __fastpackwithoutmask5(in + i * 32, out + i * num_bits);
        break;
    case 6:
        for (int i = 0; i < num_loops; ++i)
            __fastpackwithoutmask6(in + i * 32, out + i * num_bits);
        break;
    case 7:
        for (int i = 0; i < num_loops; ++i)
            __fastpackwithoutmask7(in + i * 32, out + i * num_bits);
        break;
    case 8:
        for (int i = 0; i < num_loops; ++i)
            __fastpackwithoutmask8(in + i * 32, out + i * num_bits);
        break;
    case 9:
        for (int i = 0; i < num_loops; ++i)
            __fastpackwithoutmask9(in + i * 32, out + i * num_bits);
        break;
    case 10:
        for (int i = 0; i < num_loops; ++i)
            __fastpackwithoutmask10(in + i * 32, out + i * num_bits);
        break;
    case 11:
        for (int i = 0; i < num_loops; ++i)
            __fastpackwithoutmask11(in + i * 32, out + i * num_bits);
        break;
    case 12:
        for (int i = 0; i < num_loops; ++i)
            __fastpackwithoutmask12(in + i * 32, out + i * num_bits);
        break;
    case 13:
        for (int i = 0; i < num_loops; ++i)
            __fastpackwithoutmask13(in + i * 32, out + i * num_bits);
        break;
    case 14:
        for (int i = 0; i < num_loops; ++i)
            __fastpackwithoutmask14(in + i * 32, out + i * num_bits);
        break;
    case 15:
        for (int i = 0; i < num_loops; ++i)
            __fastpackwithoutmask15(in + i * 32, out + i * num_bits);
        break;
    case 16:
        for (int i = 0; i < num_loops; ++i)
            __fastpackwithoutmask16(in + i * 32, out + i * num_bits);
        break;
    case 17:
        for (int i = 0; i < num_loops; ++i)
            __fastpackwithoutmask17(in + i * 32, out + i * num_bits);
        break;
    case 18:
        for (int i = 0; i < num_loops; ++i)
            __fastpackwithoutmask18(in + i * 32, out + i * num_bits);
        break;
    case 19:
        for (int i = 0; i < num_loops; ++i)
            __fastpackwithoutmask19(in + i * 32, out + i * num_bits);
        break;
    case 20:
        for (int i = 0; i < num_loops; ++i)
            __fastpackwithoutmask20(in + i * 32, out + i * num_bits);
        break;
    case 21:
        for (int i = 0; i < num_loops; ++i)
            __fastpackwithoutmask21(in + i * 32, out + i * num_bits);
        break;
    case 22:
        for (int i = 0; i < num_loops; ++i)
            __fastpackwithoutmask22(in + i * 32, out + i * num_bits);
        break;
    case 23:
        for (int i = 0; i < num_loops; ++i)
            __fastpackwithoutmask23(in + i * 32, out + i * num_bits);
        break;
    case 24:
        for (int i = 0; i < num_loops; ++i)
            __fastpackwithoutmask24(in + i * 32, out + i * num_bits);
        break;
    case 25:
        for (int i = 0; i < num_loops; ++i)
            __fastpackwithoutmask25(in + i * 32, out + i * num_bits);
        break;
    case 26:
        for (int i = 0; i < num_loops; ++i)
            __fastpackwithoutmask26(in + i * 32, out + i * num_bits);
        break;
    case 27:
        for (int i = 0; i < num_loops; ++i)
            __fastpackwithoutmask27(in + i * 32, out + i * num_bits);
        break;
    case 28:
        for (int i = 0; i < num_loops; ++i)
            __fastpackwithoutmask28(in + i * 32, out + i * num_bits);
        break;
    case 29:
        for (int i = 0; i < num_loops; ++i)
            __fastpackwithoutmask29(in + i * 32, out + i * num_bits);
        break;
    case 30:
        for (int i = 0; i < num_loops; ++i)
            __fastpackwithoutmask30(in + i * 32, out + i * num_bits);
        break;
    case 31:
        for (int i = 0; i < num_loops; ++i)
            __fastpackwithoutmask31(in + i * 32, out + i * num_bits);
        break;
    case 32:
        for (int i = 0; i < num_loops; ++i)
            __fastpackwithoutmask32(in + i * 32, out + i * num_bits);
        break;
    default:
...
inline int pack32(const uint32_t* in, uint32_t* out, int batch_size, int num_bits) {
    batch_size = batch_size / 32 * 32;
    int num_loops = batch_size / 32;
    ...
    case 1:
        for (int i = 0; i < num_loops; ++i)
            __fastpack1(in + i * 32, out + i * num_bits);
        break;
    case 2:
        for (int i = 0; i < num_loops; ++i)
            __fastpack2(in + i * 32, out + i * num_bits);
        break;
    case 3:
        for (int i = 0; i < num_loops; ++i)
            __fastpack3(in + i * 32, out + i * num_bits);
        break;
    case 4:
        for (int i = 0; i < num_loops; ++i)
            __fastpack4(in + i * 32, out + i * num_bits);
        break;
    case 5:
        for (int i = 0; i < num_loops; ++i)
            __fastpack5(in + i * 32, out + i * num_bits);
        break;
    case 6:
        for (int i = 0; i < num_loops; ++i)
            __fastpack6(in + i * 32, out + i * num_bits);
        break;
    case 7:
        for (int i = 0; i < num_loops; ++i)
            __fastpack7(in + i * 32, out + i * num_bits);
        break;
    case 8:
        for (int i = 0; i < num_loops; ++i)
            __fastpack8(in + i * 32, out + i * num_bits);
        break;
    case 9:
        for (int i = 0; i < num_loops; ++i)
            __fastpack9(in + i * 32, out + i * num_bits);
        break;
    case 10:
        for (int i = 0; i < num_loops; ++i)
            __fastpack10(in + i * 32, out + i * num_bits);
        break;
    case 11:
        for (int i = 0; i < num_loops; ++i)
            __fastpack11(in + i * 32, out + i * num_bits);
        break;
    case 12:
        for (int i = 0; i < num_loops; ++i)
            __fastpack12(in + i * 32, out + i * num_bits);
        break;
    case 13:
        for (int i = 0; i < num_loops; ++i)
            __fastpack13(in + i * 32, out + i * num_bits);
        break;
    case 14:
        for (int i = 0; i < num_loops; ++i)
            __fastpack14(in + i * 32, out + i * num_bits);
        break;
    case 15:
        for (int i = 0; i < num_loops; ++i)
            __fastpack15(in + i * 32, out + i * num_bits);
        break;
    case 16:
        for (int i = 0; i < num_loops; ++i)
            __fastpack16(in + i * 32, out + i * num_bits);
        break;
    case 17:
        for (int i = 0; i < num_loops; ++i)
            __fastpack17(in + i * 32, out + i * num_bits);
        break;
    case 18:
        for (int i = 0; i < num_loops; ++i)
            __fastpack18(in + i * 32, out + i * num_bits);
        break;
    case 19:
        for (int i = 0; i < num_loops; ++i)
            __fastpack19(in + i * 32, out + i * num_bits);
        break;
    case 20:
        for (int i = 0; i < num_loops; ++i)
            __fastpack20(in + i * 32, out + i * num_bits);
        break;
    case 21:
        for (int i = 0; i < num_loops; ++i)
            __fastpack21(in + i * 32, out + i * num_bits);
        break;
    case 22:
        for (int i = 0; i < num_loops; ++i)
            __fastpack22(in + i * 32, out + i * num_bits);
        break;
    case 23:
        for (int i = 0; i < num_loops; ++i)
            __fastpack23(in + i * 32, out + i * num_bits);
        break;
    case 24:
        for (int i = 0; i < num_loops; ++i)
            __fastpack24(in + i * 32, out + i * num_bits);
        break;
    case 25:
        for (int i = 0; i < num_loops; ++i)
            __fastpack25(in + i * 32, out + i * num_bits);
        break;
    case 26:
        for (int i = 0; i < num_loops; ++i)
            __fastpack26(in + i * 32, out + i * num_bits);
        break;
    case 27:
        for (int i = 0; i < num_loops; ++i)
            __fastpack27(in + i * 32, out + i * num_bits);
        break;
    case 28:
        for (int i = 0; i < num_loops; ++i)
            __fastpack28(in + i * 32, out + i * num_bits);
        break;
    case 29:
        for (int i = 0; i < num_loops; ++i)
            __fastpack29(in + i * 32, out + i * num_bits);
        break;
    case 30:
        for (int i = 0; i < num_loops; ++i)
            __fastpack30(in + i * 32, out + i * num_bits);
        break;
    case 31:
        for (int i = 0; i < num_loops; ++i)
            __fastpack31(in + i * 32, out + i * num_bits);
        break;
    case 32:
        for (int i = 0; i < num_loops; ++i)
            __fastpack32(in + i * 32, out + i * num_bits);
        break;
    default:
        throw std::runtime_error("Unsupported num_bits");
    }
...
inline int unpack32(const uint32_t* in, uint32_t* out, int batch_size, int num_bits) {
    ...
    case 0:
        for (int i = 0; i < num_loops; ++i)
            __fastunpack0(in + i * num_bits, out + i * 32);
        break;
    case 1:
        for (int i = 0; i < num_loops; ++i)
            __fastunpack1(in + i * num_bits, out + i * 32);
        break;
    case 2:
        for (int i = 0; i < num_loops; ++i)
            __fastunpack2(in + i * num_bits, out + i * 32);
        break;
    case 3:
        for (int i = 0; i < num_loops; ++i)
            __fastunpack3(in + i * num_bits, out + i * 32);
        break;
    case 4:
        for (int i = 0; i < num_loops; ++i)
            __fastunpack4(in + i * num_bits, out + i * 32);
        break;
    case 5:
        for (int i = 0; i < num_loops; ++i)
            __fastunpack5(in + i * num_bits, out + i * 32);
        break;
    case 6:
        for (int i = 0; i < num_loops; ++i)
            __fastunpack6(in + i * num_bits, out + i * 32);
        break;
    case 7:
        for (int i = 0; i < num_loops; ++i)
            __fastunpack7(in + i * num_bits, out + i * 32);
        break;
    case 8:
        for (int i = 0; i < num_loops; ++i)
            __fastunpack8(in + i * num_bits, out + i * 32);
        break;
    case 9:
        for (int i = 0; i < num_loops; ++i)
            __fastunpack9(in + i * num_bits, out + i * 32);
        break;
    case 10:
        for (int i = 0; i < num_loops; ++i)
            __fastunpack10(in + i * num_bits, out + i * 32);
        break;
    case 11:
        for (int i = 0; i < num_loops; ++i)
            __fastunpack11(in + i * num_bits, out + i * 32);
        break;
    case 12:
        for (int i = 0; i < num_loops; ++i)
            __fastunpack12(in + i * num_bits, out + i * 32);
        break;
    case 13:
        for (int i = 0; i < num_loops; ++i)
            __fastunpack13(in + i * num_bits, out + i * 32);
        break;
    case 14:
        for (int i = 0; i < num_loops; ++i)
            __fastunpack14(in + i * num_bits, out + i * 32);
        break;
    case 15:
        for (int i = 0; i < num_loops; ++i)
            __fastunpack15(in + i * num_bits, out + i * 32);
        break;
    case 16:
        for (int i = 0; i < num_loops; ++i)
            __fastunpack16(in + i * num_bits, out + i * 32);
        break;
    case 17:
        for (int i = 0; i < num_loops; ++i)
            __fastunpack17(in + i * num_bits, out + i * 32);
        break;
    case 18:
        for (int i = 0; i < num_loops; ++i)
            __fastunpack18(in + i * num_bits, out + i * 32);
        break;
    case 19:
        for (int i = 0; i < num_loops; ++i)
            __fastunpack19(in + i * num_bits, out + i * 32);
        break;
    case 20:
        for (int i = 0; i < num_loops; ++i)
            __fastunpack20(in + i * num_bits, out + i * 32);
        break;
    case 21:
        for (int i = 0; i < num_loops; ++i)
            __fastunpack21(in + i * num_bits, out + i * 32);
        break;
    case 22:
        for (int i = 0; i < num_loops; ++i)
            __fastunpack22(in + i * num_bits, out + i * 32);
        break;
    case 23:
        for (int i = 0; i < num_loops; ++i)
            __fastunpack23(in + i * num_bits, out + i * 32);
        break;
    case 24:
        for (int i = 0; i < num_loops; ++i)
            __fastunpack24(in + i * num_bits, out + i * 32);
        break;
    case 25:
        for (int i = 0; i < num_loops; ++i)
            __fastunpack25(in + i * num_bits, out + i * 32);
        break;
    case 26:
        for (int i = 0; i < num_loops; ++i)
            __fastunpack26(in + i * num_bits, out + i * 32);
        break;
    case 27:
        for (int i = 0; i < num_loops; ++i)
            __fastunpack27(in + i * num_bits, out + i * 32);
        break;
    case 28:
        for (int i = 0; i < num_loops; ++i)
            __fastunpack28(in + i * num_bits, out + i * 32);
        break;
    case 29:
        for (int i = 0; i < num_loops; ++i)
            __fastunpack29(in + i * num_bits, out + i * 32);
        break;
    case 30:
        for (int i = 0; i < num_loops; ++i)
            __fastunpack30(in + i * num_bits, out + i * 32);
        break;
    case 31:
        for (int i = 0; i < num_loops; ++i)
            __fastunpack31(in + i * num_bits, out + i * 32);
        break;
    case 32:
        for (int i = 0; i < num_loops; ++i)
            __fastunpack32(in + i * num_bits, out + i * 32);
        break;
    default:
        throw std::runtime_error("Unsupported num_bits");
    }
