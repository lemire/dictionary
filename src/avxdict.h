...
static void avxunpackdict1(const __m256i * compressed, const int64_t * dictionary, int64_t * pout) {
    ...
    _mm256_storeu_si256(out + 0,_mm256_i32gather_epi64(dictionary,_mm256_extractf128_si256(wout,0), 8)); // load from dictionary and store
    ...
    _mm256_storeu_si256(out + 2,_mm256_i32gather_epi64(dictionary,_mm256_extractf128_si256(wout,0), 8)); // load from dictionary and store
    ...
    _mm256_storeu_si256(out + 4,_mm256_i32gather_epi64(dictionary,_mm256_extractf128_si256(wout,0), 8)); // load from dictionary and store
    ...
    _mm256_storeu_si256(out + 6,_mm256_i32gather_epi64(dictionary,_mm256_extractf128_si256(wout,0), 8)); // load from dictionary and store
    ...
    _mm256_storeu_si256(out + 8,_mm256_i32gather_epi64(dictionary,_mm256_extractf128_si256(wout,0), 8)); // load from dictionary and store
    ...
    _mm256_storeu_si256(out + 10,_mm256_i32gather_epi64(dictionary,_mm256_extractf128_si256(wout,0), 8)); // load from dictionary and store
    ...
    _mm256_storeu_si256(out + 12,_mm256_i32gather_epi64(dictionary,_mm256_extractf128_si256(wout,0), 8)); // load from dictionary and store
    ...
    _mm256_storeu_si256(out + 14,_mm256_i32gather_epi64(dictionary,_mm256_extractf128_si256(wout,0), 8)); // load from dictionary and store
    ...
    _mm256_storeu_si256(out + 16,_mm256_i32gather_epi64(dictionary,_mm256_extractf128_si256(wout,0), 8)); // load from dictionary and store
    ...
    _mm256_storeu_si256(out + 18,_mm256_i32gather_epi64(dictionary,_mm256_extractf128_si256(wout,0), 8)); // load from dictionary and store
    ...
    _mm256_storeu_si256(out + 20,_mm256_i32gather_epi64(dictionary,_mm256_extractf128_si256(wout,0), 8)); // load from dictionary and store
    ...
    _mm256_storeu_si256(out + 22,_mm256_i32gather_epi64(dictionary,_mm256_extractf128_si256(wout,0), 8)); // load from dictionary and store
    ...
    _mm256_storeu_si256(out + 24,_mm256_i32gather_epi64(dictionary,_mm256_extractf128_si256(wout,0), 8)); // load from dictionary and store
    ...
    _mm256_storeu_si256(out + 26,_mm256_i32gather_epi64(dictionary,_mm256_extractf128_si256(wout,0), 8)); // load from dictionary and store
    ...
    _mm256_storeu_si256(out + 28,_mm256_i32gather_epi64(dictionary,_mm256_extractf128_si256(wout,0), 8)); // load from dictionary and store
    ...
    _mm256_storeu_si256(out + 30,_mm256_i32gather_epi64(dictionary,_mm256_extractf128_si256(wout,0), 8)); // load from dictionary and store
    ...
    _mm256_storeu_si256(out + 32,_mm256_i32gather_epi64(dictionary,_mm256_extractf128_si256(wout,0), 8)); // load from dictionary and store
    ...
    _mm256_storeu_si256(out + 34,_mm256_i32gather_epi64(dictionary,_mm256_extractf128_si256(wout,0), 8)); // load from dictionary and store
    ...
    _mm256_storeu_si256(out + 36,_mm256_i32gather_epi64(dictionary,_mm256_extractf128_si256(wout,0), 8)); // load from dictionary and store
    ...
    _mm256_storeu_si256(out + 38,_mm256_i32gather_epi64(dictionary,_mm256_extractf128_si256(wout,0), 8)); // load from dictionary and store
    ...
    _mm256_storeu_si256(out + 40,_mm256_i32gather_epi64(dictionary,_mm256_extractf128_si256(wout,0), 8)); // load from dictionary and store
    ...
    _mm256_storeu_si256(out + 42,_mm256_i32gather_epi64(dictionary,_mm256_extractf128_si256(wout,0), 8)); // load from dictionary and store
    ...
    _mm256_storeu_si256(out + 44,_mm256_i32gather_epi64(dictionary,_mm256_extractf128_si256(wout,0), 8)); // load from dictionary and store
    ...
    _mm256_storeu_si256(out + 46,_mm256_i32gather_epi64(dictionary,_mm256_extractf128_si256(wout,0), 8)); // load from dictionary and store
    ...
    _mm256_storeu_si256(out + 48,_mm256_i32gather_epi64(dictionary,_mm256_extractf128_si256(wout,0), 8)); // load from dictionary and store
    ...
    _mm256_storeu_si256(out + 50,_mm256_i32gather_epi64(dictionary,_mm256_extractf128_si256(wout,0), 8)); // load from dictionary and store
    ...
    _mm256_storeu_si256(out + 52,_mm256_i32gather_epi64(dictionary,_mm256_extractf128_si256(wout,0), 8)); // load from dictionary and store
    ...
    _mm256_storeu_si256(out + 54,_mm256_i32gather_epi64(dictionary,_mm256_extractf128_si256(wout,0), 8)); // load from dictionary and store
    ...
    _mm256_storeu_si256(out + 56,_mm256_i32gather_epi64(dictionary,_mm256_extractf128_si256(wout,0), 8)); // load from dictionary and store
    ...
    _mm256_storeu_si256(out + 58,_mm256_i32gather_epi64(dictionary,_mm256_extractf128_si256(wout,0), 8)); // load from dictionary and store
    ...
    _mm256_storeu_si256(out + 60,_mm256_i32gather_epi64(dictionary,_mm256_extractf128_si256(wout,0), 8)); // load from dictionary and store
    ...
    _mm256_storeu_si256(out + 62,_mm256_i32gather_epi64(dictionary,_mm256_extractf128_si256(wout,0), 8)); // load from dictionary and store
